<link href="{{ asset("public/css/fileinput.css") }}" rel="stylesheet">
...
;(function($, window, document) {
	$( document ).ready(function () {
	    ...
	    var deleteTemplate = '<button type="button" class="delete_im btn btn-kv btn-default btn-flat btn-xs" data-toggle="tooltip" data-placement="top" title="{{ trans('app.remove') }}" {dataUrl}{dataKey}><i {dataUrl}{dataKey} class="fa fa-trash delete_im"></i></button>\n';
	    ...
	    $("#dropzone-input").fileinput({
	        ...
	        dropZoneTitle: "{{ trans('lang_data.drag_n_drop_here') }}",
	        showClose: false,
	        showRemove: false,
	        showCaption: false,
	    	...
	    	var sortUrl = "{{ route('admin.image.sort') }}";
