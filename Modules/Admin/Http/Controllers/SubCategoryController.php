...
{   
    ...
    public function __construct(){
        ...
        {
            $this->user = \Auth::user();
            if (CHECK_RIGHTS_TO_ACCESS_DENIED(Acl::CONST_SUB_CATEGORY_MODULE, $this->user
    ...
    {       
        $title =trans('lang_data.sub_category_list_label');
        return view('admin::sub_category.index',compact('title'));
    }
    ...
    {
        $image="";
        $title =trans('lang_data.add_sub_category_label');
        return view('admin::sub_category.addedit',compact("image","title"));
    }
    ...
    {
        return $this->objModel->saveSubCategory($request);
    }
    ...
    {
        $category=$this->objModel->getSubCategory(Crypt::decrypt($id));
        $encryptedId=$id;
        $image=$category->image;
        $title =trans('lang_data.edit_sub_category_label');
        return view('admin::sub_category.addedit',compact("category","encryptedId","image",'title'));
    }
    ...
    {
        //
        return $this->objModel->saveSubCategory($request,$id);
    }
    ...
    {
        return $this->objModel->getSubCategoryListData($r);
    }
