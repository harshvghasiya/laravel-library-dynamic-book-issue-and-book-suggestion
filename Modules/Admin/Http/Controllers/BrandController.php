...
{   
    ...
    public function __construct(){
        ...
        {
            $this->user = \Auth::user();
            if (CHECK_RIGHTS_TO_ACCESS_DENIED(Acl::CONST_BRAND_MODULE, $this->user
    ...
    {       
        $title =trans('lang_data.brand_list_label');
    ...
    {
        $title =trans('lang_data.add_brand_label');
        return view('admin::brand.addedit',compact("title"));
    }
    ...
    {
        return $this->objModel->saveBrand($request);
    }
    ...
    {
        $brand = $this->objModel->getBrand(Crypt::decrypt($id));
        $encryptedId=$id;
        $title =trans('lang_data.edit_brand_label');
        return view('admin::brand.addedit',compact("brand","encryptedId",'title'));
    }
    ...
    {
        //
        return $this->objModel->saveBrand($request,$id);
    }
    ...
    {
        return $this->objModel->getBrandListData($r);
    }
