		...
		<div class="row">
			<div class="col-lg-9 col-md-9 col-sm-9">
				...
				<div id="shop-all" class="row">
						...
						<?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="col-xs-12 col-sm-6 col-md-4 product-item filter-best">
								<div class="product-img">
									<img class="product_list_img" src="<?php echo e($v->getProductImageUrl('thumbnail_')); ?>" alt="<?php echo e($category->name); ?>">
								</div>
					...
					<?php else: ?>
						<div class="col-xs-12 col-sm-6 col-md-8 col-md-offset-5">
							<h4>Category product not found</h4>	
						</div>
					<?php endif; ?>
				</div>
			</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel_ecommerce/resources/views/front/category/index.blade.php ENDPATH**/ ?>