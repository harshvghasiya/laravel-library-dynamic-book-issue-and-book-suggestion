									...
									<div style="width:100% !important;">
										<div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
											<div align="center" class="img-container center fixedwidth" style="padding-right: 40px;padding-left: 40px;">
												...
												src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/img/softtechover_logo.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 150px; display: block;" title="<?php echo e(trans('lang_data.app_name')); ?>" width="352"/>
											</div>
											<?php
...
</html><?php /**PATH C:\laragon\www\newlaunch\resources\views/emails/mail_template.blade.php ENDPATH**/ ?>