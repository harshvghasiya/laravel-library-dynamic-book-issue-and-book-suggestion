                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="control-label col-md-3"><?php echo e(trans('lang_data.total_category')); ?></label>
                          <div class="col-md-9">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="col-md-10 col-md-offset-1">
                            <?php echo e(Form::textarea('long_description',null,['id'=>'long_description','class'=>'form-control'])); ?>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\softtechover\Modules/Admin\Resources/views/blog/addedit.blade.php ENDPATH**/ ?>