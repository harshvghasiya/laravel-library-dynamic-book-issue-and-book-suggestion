...
<div class="row margin-top-10">
		...
		<div class="dashboard-stat2">
			<a href="<?php echo e(route('admin.tag.index')); ?>">
				<div class="display">
					<div class="number">
						<div class="icon">
							<i class="fa fa-tag" aria-hidden="true"></i> <small><?php echo e(trans('lang_data.tag')); ?></small>
						</div>
					</div>
				</div>
			</a>
	...
	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
		<div class="dashboard-stat2">
			<a href="<?php echo e(route('admin.technology.index')); ?>">
				<div class="display">
					<div class="number">
						<div class="icon">
							<i class="fa fa-puzzle-piece" aria-hidden="true"></i> <small><?php echo e(trans('lang_data.technology')); ?></small>
						</div>
					</div>
				</div>
			</a>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/i1qxzjn7zpro/public_html/softtechover_phase_3/newlaunch/Modules/Admin/Resources/views/dashboard.blade.php ENDPATH**/ ?>