              ...
              <div class="portlet-body form">
                  ...
                  <div class="form-body">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <?php echo e(Form::select('parent_id',[''=>trans('lang_data.select_parent_category_label')]+ \App\Models\Cms::getCmsDropDown(),null,['id'=>'',"class"=>"form-control"])); ?>
                       ...
                       <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            ...
                            ?>
                            <?php echo e(Form::select('module_id[]',[''=>trans('lang_data.select_module_category_label')]+ \App\Models\Module::getModuleDropDown(),$selectedData,['id'=>'',"class"=>"form-control",'multiple'=>true])); ?>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="control-label col-md-3"><?php echo e(trans('lang_data.display_on_header_label')); ?></label>
                          <div class="col-md-9">
                            <div class="radio-list">
                              <label class="radio-inline">
                              <input type="radio" name="display_on_header" value="1" <?php echo e(isset($cms)?($cms->display_on_header == 1)?'checked':'':'checked'); ?> />
                              <?php echo e(trans('lang_data.yes_label')); ?> </label>
                              <label class="radio-inline">
                              <input type="radio" name="display_on_header" value="0" <?php echo e(isset($cms)?($cms->display_on_header == 0)?'checked':'':''); ?> />
                              <?php echo e(trans('lang_data.no_label')); ?> </label>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="control-label col-md-3"><?php echo e(trans('lang_data.display_on_footer_label')); ?></label>
                          <div class="col-md-9">
                            <div class="radio-list">
                              <label class="radio-inline">
                              <input type="radio" name="display_on_footer" value="1" <?php echo e(isset($cms)?($cms->display_on_footer == 1)?'checked':'':'checked'); ?> />
                              <?php echo e(trans('lang_data.yes_label')); ?> </label>
                              <label class="radio-inline">
                              <input type="radio" name="display_on_footer" value="0" <?php echo e(isset($cms)?($cms->display_on_footer == 0)?'checked':'':''); ?> />
                              <?php echo e(trans('lang_data.no_label')); ?> </label>
                            </div>
                          </div>
                        </div>
                     ...
                     <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="control-label col-md-3"><?php echo e(trans('lang_data.font_icon_label')); ?></label>
                          <div class="col-md-9">
                            <?php echo e(Form::text('font_icon',null,['placeholder'=>trans('lang_data.font_icon_label'),'id'=>'font_icon','class'=>'form-control'])); ?>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="control-label col-md-3"><?php echo e(trans('lang_data.description_label')); ?></label>
                          <div class="col-md-9">
                            <?php echo e(Form::textarea('description',null,['id'=>'description','class'=>'form-control'])); ?>
