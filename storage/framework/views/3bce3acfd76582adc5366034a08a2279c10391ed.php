                  ...
                  <div class="form-body">
                    ...
                    <h3 class="form-section"><?php echo e(trans('lang_data.descritoon_template_label')); ?></h3>
                     <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            <label class="control-label col-md-3"><?php echo e(trans('lang_data.description_label')); ?></label><br><br>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\softtechover\Modules/Admin\Resources/views/email_template/addedit.blade.php ENDPATH**/ ?>