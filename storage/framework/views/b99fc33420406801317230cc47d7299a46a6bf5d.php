                  ...
                  <div class="portlet-body form">
                      ...
                      <div class="form-body">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label col-md-3"><?php echo e(trans('lang_data.author_des_footer_label')); ?></label>
                              <div class="col-md-9">
                         ...
                         <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label col-md-3"><?php echo e(trans('lang_data.author_des_sidebar_label')); ?></label>
                              <div class="col-md-9">
                        ...
                        <div class="row">
                         ...
                         <h3 class="form-section"><?php echo e(trans('lang_data.map_detail_label')); ?></h3>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label col-md-3"><?php echo e(trans('lang_data.latitude_lable')); ?></label>
                              <div class="col-md-9">
                                <?php echo e(Form::text('address_latitude',null,['id'=>'address_latitude','class'=>'form-control'])); ?>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label col-md-3"><?php echo e(trans('lang_data.longitude_lable')); ?></label>
                              <div class="col-md-9">
                                <?php echo e(Form::text('address_longitude',null,['id'=>'longitude','class'=>'form-control'])); ?>
                           ...
                           <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label col-md-3"><?php echo e(trans('lang_data.address_name_map_label')); ?></label>
                              <div class="col-md-9">
                                <?php echo e(Form::textarea('map_address',null,['id'=>'map_address','class'=>'form-control'])); ?>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/i1qxzjn7zpro/public_html/softtechover_phase_3/newlaunch/Modules/Admin/Resources/views/setting/setting.blade.php ENDPATH**/ ?>