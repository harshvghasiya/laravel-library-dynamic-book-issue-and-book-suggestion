...
<ul class="page-breadcrumb breadcrumb">
  ...
  <li class="active">
     <?php echo e(trans('lang_data.blog_list_label')); ?>
  ...
  <div class="col-md-12">
    ...
    <div class="portlet box grey-cascade">
      <div class="portlet-title">
        <div class="caption">
          <i class="fa fa-globe"></i><?php echo e(trans('lang_data.managed_blog_label')); ?>
      ...
      <div class="portlet-body">
        <div class="table-toolbar">
          <div class="row">
            <div class="col-md-6">
              <div class="btn-group">
                <a href="<?php echo e(route('admin.blogs.create')); ?>" id="sample_editable_1_new" class="btn green">
                <?php echo e(trans('lang_data.add_new_label')); ?> <i class="fa fa-plus"></i>
                </a>
              </div>
              <?php if(env('ACCESS_TO_DELETE') == true): ?>
              <div class="btn-group">
                <a class="btn btn-danger" onclick="deleteAll('table_form','<?php echo e(route('admin.blogs.delete_all')); ?>')"><?php echo e(trans('lang_data.delete_all_label')); ?>

                </a>
              </div>
              <?php endif; ?>
              <div class="btn-group">
                <a class="btn btn-warning" onclick="statusAll('table_form','<?php echo e(route('admin.blogs.status_all')); ?>')"><?php echo e(trans('lang_data.status_all_label')); ?>
        ...
        <table class="table table-striped table-bordered table-hover" id="users-table">
          <thead>
            <tr>
              ...
              <th><?php echo e(trans('lang_data.total_category')); ?></th>
...
<script>
  var oTable = $('#users-table').DataTable({
      ...
      responsive: true,
      ajax: {
            url:'<?php echo route('admin.blogs.any_data'); ?>',
            data: function (d) {
    ...
    $(document).on("click","#active_inactive",function(){
      ...
      .then((willDelete) => {
        if (willDelete) {
              ...
              $.ajax({
                type:"POST",
                url:"<?php echo e(route('admin.blogs.single_status_change')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/i1qxzjn7zpro/public_html/softtechover_phase_3/newlaunch/Modules/Admin/Resources/views/blog/index.blade.php ENDPATH**/ ?>