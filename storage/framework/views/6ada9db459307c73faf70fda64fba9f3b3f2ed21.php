...
<ul class="page-breadcrumb breadcrumb">
  ...
  <li>
    <a href="<?php echo e(route('admin.country.index')); ?>"><?php echo e(trans('lang_data.country_list_label')); ?></a><i class="fa fa-circle"></i>
  </li>
  <li class="active">
    <?php if(isset($country)): ?>
      <?php echo e(trans('lang_data.edit_country_label')); ?>

    <?php else: ?>
      <?php echo e(trans('lang_data.add_country_label')); ?>
          ...
          <div class="" id="tab_2">
            <div class="portlet box green">
              ...
              <div class="portlet-body form">
                  ...
                  <?php endif; ?>
                  <div class="form-body">
                    <h3 class="form-section"><?php echo e(trans('lang_data.country_info_label')); ?></h3>
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <div class="radio-list">
                              ...
                              <input type="radio" name="status" value="1" <?php echo e(isset($country)?($country->status == 1)?'checked':'':'checked'); ?> />
                              <?php echo e(trans('lang_data.active_label')); ?> </label>
                              <label class="radio-inline">
                              <input type="radio" name="status" value="0" <?php echo e(isset($country)?($country->status == 0)?'checked':'':''); ?> />
                      ...
                      <div class="col-md-6">
                        <div class="row">
                          <div class="col-md-offset-3 col-md-9">
                            ...
                            <a href="<?php echo e(route('admin.country.index')); ?>" type="button" class="btn default"><?php echo e(trans('lang_data.cancel_label')); ?></a>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel_ecommerce/Modules/Admin/Resources/views/country/addedit.blade.php ENDPATH**/ ?>