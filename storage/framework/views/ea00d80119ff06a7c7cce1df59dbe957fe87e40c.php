              ...
              <div class="col-12 col-md-7 col-lg-8">
                  ...
                  <div class="vizew-post-author d-flex align-items-center" id="p_index">
                      <div class="post-author-thumb">
                          <img src="<?php echo e($setting->getsettineAuthorImgDynamic()); ?>" alt="<?php echo e($setting->author_name ? $setting->author_name : ''); ?>">
                      </div>
                      <div class="post-author-desc pl-4">
                          <a href="javascript:void(0)" class="author-name"><?php echo e($setting->author_name ? $setting->author_name : ''); ?></a>
                          <p><?php echo e($setting->author_description_two ? $setting->author_description_two : ""); ?></p>
                    ...
                    <?php if(isset($categoryListing) && !$categoryListing->isEmpty()): ?>
                      <div class="single-widget youtube-channel-widget mb-50">
                          ...
                          <?php $__currentLoopData = $categoryListing; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <li><a href="<?php echo e(route('front.category.category_single',$c->slug)); ?>" class="channel-title"><?php echo e($c->name); ?> <span><?php echo e($c->blog_count); ?></span></a></li>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>    
                            </ul>
                          </div>
                      </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\softtechover\resources\views/search_all_post.blade.php ENDPATH**/ ?>