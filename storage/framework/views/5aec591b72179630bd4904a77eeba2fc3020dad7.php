...
<ul class="page-breadcrumb breadcrumb">
  <li>
    <a href="<?php echo e(route('admin.dashboard')); ?>">Home</a><i class="fa fa-circle"></i>
  </li>
  <li class="active">
     Edit setting
  </li>
              ...
              <div class="" id="tab_2">
                <div class="portlet box green">
                  <div class="portlet-title">
                    <div class="caption">
                      <i class="fa fa-gift"></i>Edit setting
                    </div>
                  </div>
                  <div class="portlet-body form">
                      ...
                      <div class="form-body">
                        ...
                        <div class="row">
                         ...
                         <h3 class="form-section">Description Details</h3>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label col-md-3">Author Desciption Sidebar</label>
                              <div class="col-md-9">
                                <?php echo e(Form::textarea('author_description_one',null,['id'=>'author_description_one','class'=>'form-control'])); ?>
                         ...
                         <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label col-md-3">Author Desciption Sidebar</label>
                              <div class="col-md-9">
                                <?php echo e(Form::textarea('author_description_two',null,['id'=>'author_description_two','class'=>'form-control'])); ?>
                                  ...
                                  <?php if(isset($setting) && $setting->logo_image !=null): ?>
                                    <div class="row">
                                        <div class="col-sm-6 imgUp">
                                          ...
                                          <label class="btn btn-danger"><a id="deleteImage" data-name="logo_image" href="javascript:void(0)">Delete</a></label>
                                        </div>
                                      </div>
                                  <?php endif; ?>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 imgUp">
                                          <div class="imagePreview" style="background: url(<?php echo e($setting->getsettineFaviconImgDynamic()); ?>)"></div>
                                            <label class="btn btn-danger"><a id="deleteImage" data-name="favicon_image" href="javascript:void(0)">Delete</a></label>
                                        </div>
                                      </div>
                                  <?php endif; ?>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 imgUp">
                                          <div class="imagePreview" style="background: url(<?php echo e($setting->getsettineEmailImgDynamic()); ?>)"></div>
                                            <label class="btn btn-danger"><a id="deleteImage" data-name="email_image" href="javascript:void(0)">Delete</a></label>
                                        </div>
                                      </div>
                                  <?php endif; ?>
                                </div>
                                  ...
                                  <?php if(isset($setting) && $setting->home_page_banner_image !=""): ?>
                                    <div class="row">
                                        <div class="col-sm-6 imgUp">
                                          ...
                                          <label class="btn btn-danger"><a id="deleteImage" data-name="home_page_banner_image" href="javascript:void(0)">Delete</a></label>
                                        </div>
                                      </div>
                                  <?php endif; ?>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 imgUp">
                                          <div class="imagePreview" style="background: url(<?php echo e($setting->getsettineAuthorImgDynamic()); ?>)"></div>
                                            <label class="btn btn-danger"><a id="deleteImage" data-name="author_image" href="javascript:void(0)">Delete</a></label>
                                        </div>
                                      </div>
                                  <?php endif; ?>
                                </div>
  ...
  $('#filer_input5').filer({
    ...
    $("#AddEditSetting").validate({
        rules: {
           ...
           'favicon_image[]': { extension: "jpg|png|jpeg" },
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/softtechover/Modules/Admin/Resources/views/setting/setting.blade.php ENDPATH**/ ?>