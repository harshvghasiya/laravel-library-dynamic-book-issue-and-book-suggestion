		...
		<div class="container">
			<div class="row">
				<div class="subscribe scrollme">	
					...
					<img src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/img/subscr-mailopen.png" alt="mail" class="mail-2">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="info">
				<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
					<div class="heading">
						...
						<p class="heading-text"><?php echo $setting->second_address; ?>
				...
				<?php if(isset($footerSectionLink) && !$footerSectionLink->isEmpty()): ?>
					...
					<div class="services">
						...
						<ul class="list list--primary">
							...
							<li><i class="fa fa-caret-right" aria-hidden="true"></i> 
								<a href="<?php echo e(route('front.cms.details',$v->slug)); ?>"><?php echo e($v->name); ?></a>
							</li>
							<?php endif; ?>
							<?php else: ?>
							<li><i class="fa fa-caret-right" aria-hidden="true"></i>
...
<script src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/js/js-plugins/crum-mega-menu.js"></script>
<script src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/js/js-plugins/swiper.jquery.min.js"></script>
<script src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/js/js-plugins/waypoints.js"></script>
<script src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/js/js-plugins/jquery.drawsvg.js"></script>
<script src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/js/js-plugins/jquery-countTo.js"></script>
<script src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/js/js-plugins/jquery.mousewheel.js"></script>
<script src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/js/js-plugins/jquery.mCustomScrollbar.js"></script>
<script src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/js/js-plugins/imagesLoaded.js"></script>
<script src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/js/js-plugins/jquery.magnific-popup.js"></script>
<script src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/js/js-plugins/jquery.matchHeight.js"></script>
<script src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/js/js-plugins/segment.js"></script>
<script src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/js/js-plugins/bootstrap.js"></script>
<script src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/js/js-plugins/jquery-circle-progress.js"></script>
<script src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/js/js-plugins/Headroom.js"></script>
<script src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/js/js-plugins/jquery.nice-select.js"></script>
<script src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/js/js-plugins/fastClick.js"></script>
<script src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/js/js-plugins/velocity.js"></script>
<script src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/js/js-plugins/time-line.js"></script>
<script src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/js/js-plugins/ScrollMagic.min.js"></script>
<script src="<?php echo e(UPLOAD_AND_DOWNLOAD_URL()); ?>public/front/js/js-plugins/animation.velocity.min.js"></script>
...
<?php /**PATH /home/i1qxzjn7zpro/public_html/softtechover_phase_3/newlaunch/resources/views/layouts/footer.blade.php ENDPATH**/ ?>