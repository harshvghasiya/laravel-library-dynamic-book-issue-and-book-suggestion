  ...
  <div class="container">
    ...
    <nav id="primary-menu" class="primary-menu">
     ...
     <ul class="primary-menu-menu">
      ...
      <?php if(isset($menuLinks) && !$menuLinks->isEmpty()): ?>
      <?php $__currentLoopData = $menuLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php 
      ...
      ?>
      <?php if(isset($v->children_id) &&$v->children_id != null): ?>
      <li <?php echo e($cmsActiveClass); ?>><a <?php if($v->menuitem->target == 2): ?> target="_blank" <?php endif; ?> <?php if( $v->menuitem->slug != null && $v->menuitem->target != 3): ?>href="<?php echo e(route('front.cms.details',$v->menuitem->slug)); ?>"<?php else: ?> href="javascript:void();" <?php endif; ?>><?php echo e($v->menuitem->name); ?></a>
        <ul class="dropdown">
          <?php $__currentLoopData = json_decode($v->children_id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <li class="hover-ver2">
            <a <?php if($val->target == 2): ?> target="_blank" <?php endif; ?> <?php if( $val->slug != null && $val->target != 3): ?> href="<?php echo e(route('front.cms.details',$val->slug)); ?>" <?php else: ?> href="javascript:void();" <?php endif; ?>>
              <?php echo e($val->name); ?>
      ...
      <li <?php echo e($cmsActiveClass); ?>><a <?php if($v->menuitem->target == 2): ?> target="_blank" <?php endif; ?> <?php if( $v->menuitem->slug != null && $v->menuitem->target != 3): ?>href="<?php echo e(route('front.cms.details',$v->menuitem->slug)); ?>"<?php else: ?> href="javascript:void();" <?php endif; ?>><?php echo e($v->menuitem->name); ?></a></li>
      <?php endif; ?>             
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      <?php endif; ?>
    </ul>
