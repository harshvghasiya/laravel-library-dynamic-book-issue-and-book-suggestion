  ...
  $(document).ready(function(){
    $("#AddEditBanner").validate({
        ...
        messages:{
           ...
           'url': { url:"<?php echo e(trans('lang_data.please_enter_valid_banner_URL_label')); ?>" }
        },
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel_ecommerce/Modules/Admin/Resources/views/banner/addedit.blade.php ENDPATH**/ ?>