                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="col-md-9">
                              ...
                              <?php if(isset($socialMedia) && $socialMedia->image !=null): ?>
                                <div class="row">
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel_ecommerce/Modules/Admin/Resources/views/social_media/addedit.blade.php ENDPATH**/ ?>