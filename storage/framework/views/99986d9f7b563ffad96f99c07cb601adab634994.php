...
<ul class="page-breadcrumb breadcrumb">
  ...
  <li class="active">
     <?php echo e(trans('lang_data.acl_listing')); ?>
  ...
  <div class="col-md-12">
              ...
              <form method="POST" id="search-form" class="form-inline" role="form">
                <?php echo e(csrf_field()); ?>
                  ...
                  <div class="form-group">
                      <label for="title"><?php echo e(trans('lang_data.title_label')); ?></label>
                      <input type="text" class="form-control" name="title" id="title" placeholder="<?php echo e(trans('lang_data.search_title_label')); ?>">
                  </div>
                  <div class="form-group">
    ...
    <div class="portlet box grey-cascade">
      <div class="portlet-title">
        <div class="caption">
          <i class="fa fa-globe"></i><?php echo e(trans('lang_data.manage_acl_label')); ?>
      ...
      <div class="portlet-body">
        <div class="table-toolbar">
          <div class="row">
            <div class="col-md-6">
              <div class="btn-group">
                <a href="<?php echo e(route('admin.acl.create')); ?>" id="sample_editable_1_new" class="btn green">
                Add New <i class="fa fa-plus"></i>
                </a>
              </div>
              <?php if(env('ACCESS_TO_DELETE') == true): ?>
              <div class="btn-group">
                <a class="btn btn-danger" onclick="deleteAll('table_form','<?php echo e(route('admin.acl.delete_all')); ?>')"><?php echo e(trans('lang_data.delete_all_label')); ?>

                </a>
              </div>
              <?php endif; ?>
              <div class="btn-group">
                <a class="btn btn-warning" onclick="statusAll('table_form','<?php echo e(route('admin.acl.status_all')); ?>')"><?php echo e(trans('lang_data.status_all_label')); ?>
...
<script>
  var oTable = $('#users-table').DataTable({
      ...
      responsive: true,
      ajax: {
            url:'<?php echo route('admin.acl.any_data'); ?>',
            data: function (d) {
    ...
    $(document).on("click","#active_inactive",function(){
      ...
      .then((willDelete) => {
        if (willDelete) {
              ...
              $.ajax({
                type:"POST",
                url:"<?php echo e(route('admin.acl.single_status_change')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel_admin_demo/Modules/Admin/Resources/views/acl/index.blade.php ENDPATH**/ ?>