	...
	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
		<div class="dashboard-stat2">
			<a href="<?php echo e(route('admin.acl.index')); ?>">
				<div class="display">
					<div class="number">
						<h3 class="font-green-sharp"><?php echo e($count['acl']); ?></h3>
						<small><?php echo e(trans('lang_data.acl')); ?></small>
					</div>
					<div class="icon">
						<i class="fa fa-file-image-o" aria-hidden="true"></i>
					</div>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/softtechover/Modules/Admin/Resources/views/dashboard.blade.php ENDPATH**/ ?>