 ...
 <div class="all-posts-area">
    <div class="section-heading style-2">
        <?php if(isset($searchKeyword) && $searchKeyword !=""): ?>
            <h4>Your search result for '<?php echo e($searchKeyword); ?>'</h4>
        <?php else: ?>
            <h4>Latest Post</h4>
        <?php endif; ?>
        <div class="line"></div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    <div class="post-content mt-0">
                        ...
                        <?php endif; ?>
                        <a target="_blank" href="<?php echo e(route('front.blog.details',$blog->slug)); ?>" class="post-title mb-2"><?php echo e($blog->name); ?></a>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\softtechover\resources\views/front/home/pagination_latest_blog.blade.php ENDPATH**/ ?>