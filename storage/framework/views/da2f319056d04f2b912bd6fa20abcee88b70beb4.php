                  ...
                  <div class="form-body">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                       ...
                       <div class="col-md-6">
                        <div class="form-group">
                          <label class="control-label col-md-3"><?php echo e(trans('lang_data.background_color_label')); ?></label>
                          <div class="col-md-9">
                            <?php echo e(Form::color('bg_color',null,['placeholder'=>trans('lang_data.add_banner_url'),'id'=>'bg_color','class'=>'form-control'])); ?>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <div class="radio-list">
                              ...
                              <input type="radio" name="display_on_header" value="1" <?php echo e(isset($category)?($category->display_on_header == 1)?'checked':'':'checked'); ?> />
                              <?php echo e(trans('lang_data.yes_label')); ?> </label>
                              <label class="radio-inline">
                              <input type="radio" name="display_on_header" value="0" <?php echo e(isset($category)?($category->display_on_header == 0)?'checked':'':''); ?> />
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <div class="radio-list">
                              <label class="radio-inline">
                              <input type="radio" name="display_on_footer" value="1" <?php echo e(isset($category)?($category->display_on_footer == 1)?'checked':'':'checked'); ?> />
                              <?php echo e(trans('lang_data.yes_label')); ?> </label>
                              <label class="radio-inline">
                              <input type="radio" name="display_on_footer" value="0" <?php echo e(isset($category)?($category->display_on_footer == 0)?'checked':'':''); ?> />
                              <?php echo e(trans('lang_data.no_label')); ?> </label>
                            </div>
                          </div>
                        </div>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/softtechover/Modules/Admin/Resources/views/category/addedit.blade.php ENDPATH**/ ?>