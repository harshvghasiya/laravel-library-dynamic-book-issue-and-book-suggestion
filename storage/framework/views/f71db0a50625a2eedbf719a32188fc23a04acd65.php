...
<ul class="page-breadcrumb breadcrumb">
  ...
  <li class="active">
     <?php echo e(trans('lang_data.module_list_label')); ?>
  ...
  <div class="col-md-12">
    ...
    <div class="portlet box grey-cascade">
      <div class="portlet-title">
        <div class="caption">
          <i class="fa fa-globe"></i><?php echo e(trans('lang_data.managed_module_label')); ?>
      ...
      <div class="portlet-body">
        <div class="table-toolbar">
          <div class="row">
            <div class="col-md-6">
              <div class="btn-group">
                <a href="<?php echo e(route('admin.modules.create')); ?>" id="sample_editable_1_new" class="btn green">
                <?php echo e(trans('lang_data.add_new_label')); ?> <i class="fa fa-plus"></i>
                </a>
              </div>
              <?php if(env('ACCESS_TO_DELETE') == true): ?>
              <div class="btn-group">
                <a class="btn btn-danger" onclick="deleteAll('table_form','<?php echo e(route('admin.modules.delete_all')); ?>')"><?php echo e(trans('lang_data.delete_all_label')); ?>

                </a>
              </div>
              <?php endif; ?>
              <div class="btn-group">
                <a class="btn btn-warning" onclick="statusAll('table_form','<?php echo e(route('admin.modules.status_all')); ?>')"><?php echo e(trans('lang_data.status_all_label')); ?>
...
<script>
  var oTable = $('#users-table').DataTable({
      ...
      responsive: true,
      ajax: {
            url:'<?php echo route('admin.modules.any_data'); ?>',
            data: function (d) {
    ...
    $(document).on("click","#active_inactive",function(){
      ...
      .then((willDelete) => {
        if (willDelete) {
              ...
              $.ajax({
                type:"POST",
                url:"<?php echo e(route('admin.modules.single_status_change')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel_admin_demo/Modules/Admin/Resources/views/module/index.blade.php ENDPATH**/ ?>