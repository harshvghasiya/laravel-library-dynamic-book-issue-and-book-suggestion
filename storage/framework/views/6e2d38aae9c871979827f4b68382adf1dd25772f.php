                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            <ul>
                                ...
                                <?php if(isset($contactUsPageHeader) && !empty($contactUsPageHeader)): ?>
                                     <?php 
                                        if (\Request::segment(1) == $contactUsPageHeader->slug) {
                                            $classActiveCms = "class=active";
                                        }else{
                                            $classActiveCms ="";
                                        }
                                    ?>   
                                    <li <?php echo e($classActiveCms); ?>><a href="<?php echo e(route('front.cms.details',$contactUsPageHeader->slug)); ?>"><?php echo e($contactUsPageHeader->name); ?></a></li>
                                <?php endif; ?>
                            </ul>
                        </div>
                    </div>
...
</header><?php /**PATH C:\xampp\htdocs\softtechover\resources\views/layouts/header.blade.php ENDPATH**/ ?>