                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 table-cell">
                                            <div class="time-line-thumb">
                                                <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/img/time-line-thumb.png" alt="time-line">
                                            </div>
                                        </div>
                                ...
                                <div class="row medium-padding120">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="slider-profit-thumb">
                                            <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/img/profit.png" alt="profit">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row pb120">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="teammembers-item">
                        <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/img/teammember1.png" alt="team member">
                        ...
                        <div class="socials">
                            ...
                            <a href="" class="social__item">
                                <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/svg/circle-facebook.svg" alt="facebook">
                            </a>

                            <a href="" class="social__item">
                                <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/svg/twitter.svg" alt="twitter">
                            </a>

                            <a href="" class="social__item">
                                <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/svg/google.svg" alt="google">
                            </a>

                            <a href="" class="social__item">
                                <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/svg/youtube.svg" alt="youtube">
                            </a>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="teammembers-item">
                        <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/img/teammember2.png" alt="team member">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="teammembers-item">
                        <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/img/teammember4.png" alt="team member">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-sx-12">
                            <div class="info-box--standard">
                                <div class="info-box-image f-none">
                                    <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/img/info-box20.png" alt="image">
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-sx-12">
                            <div class="info-box--standard">
                                <div class="info-box-image f-none">
                                    <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/img/info-box21.png" alt="image">
                                </div>
                                <div class="info-box-content">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-sx-12">
                            <div class="info-box--standard">
                                <div class="info-box-image f-none">
                                    <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/img/info-box22.png" alt="image">
                                </div>
                                <div class="info-box-content">
        ...
        <div class="container-fluid">
            <div class="row bg-orangedark-color">
                ...
                <div class="our-vision scrollme">
                    ...
                    <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/img/elements.png" class="elements" alt="elements">
                    <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/img/eye.png" class="eye" alt="eye">
                </div>
            </div>
        </div>
                                    ...
                                    <div class="case-slider-item swiper-slide">
                                            ...
                                            <div class="testimonial-item testimonial-arrow mb30">
                                                ...
                                                <div class="author-info-wrap table">
                                                    <div class="testimonial-img-author table-cell">
                                                        <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/img/avatar.png" alt="author">
                                                    </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="testimonial-item testimonial-arrow mb30">
                                                ...
                                                <div class="author-info-wrap table">
                                                    <div class="testimonial-img-author table-cell">
                                                        <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/img/avatar3.png" alt="author">
                                                    </div>
                                                    <div class="author-info table-cell">
                        ...
                        <div class="clients-item-wrap">
                            ...
                            <div class="client-item mb60">
                                <a href="09_our_clients.html" class="client-image">
                                    <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/img/client1-hover.png" alt="logo" class="hover">
                                </a>
                            </div>

                            <div class="client-item mb60">
                                <a href="09_our_clients.html" class="client-image">
                                    <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/img/client2-hover.png" alt="logo" class="hover">
                                </a>
                            </div>

                            <div class="client-item mb60">
                                <a href="09_our_clients.html" class="client-image">
                                    <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/img/client3-hover.png" alt="logo" class="hover">
                                </a>
                            </div>

                            <div class="client-item mb60">
                                <a href="09_our_clients.html" class="client-image">
                                    <img src="{{UPLOAD_AND_DOWNLOAD_URL()}}public/front/img/client4-hover.png" alt="logo" class="hover">
                                </a>
                            </div>
                        </div>
                    </div>
